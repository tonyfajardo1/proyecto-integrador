...
# PROPUESTA DE SELECCION (RECOMENDACION)

Dado el alcance de un proyecto integrador, recomiendo elegir **2-3 preguntas principales**:

## Opcion A: Enfoque Comercial
1. **Devoluciones** (impacto directo en perdidas)
2. **Rutas de vendedores** (optimizacion de ventas)

## Opcion B: Enfoque Produccion
1. **Desperdicios** (reduccion de costos)
2. **Ordenes de produccion** (mejora de cumplimiento)

## Opcion C: Enfoque Mixto (Recomendado)
1. **Devoluciones** - Analisis de por que ocurren
2. **Desperdicios** - Factores que los causan
3. **Deteccion de anomalias** - Control interno

Esta opcion cubre:
- Area comercial (devoluciones)
- Area produccion (desperdicios)
- Area control/auditoria (anomalias)

---

# NUEVO TITULO SUGERIDO

**"Aplicacion de Tecnicas de Data Mining para el Analisis de Devoluciones, Reduccion de Desperdicios y Deteccion de Anomalias Operativas en CONDIMENSA"**

O mas conciso:
**"Data Mining para Optimizacion de Procesos Comerciales y Productivos en CONDIMENSA"**

---

# SIGUIENTES PASOS

1. **Confirma las 2-3 preguntas** que quieres abordar
2. Actualizo tu documento de planificacion con el nuevo enfoque
3. Restructuramos los objetivos especificos
4. Definimos los experimentos y metricas de evaluacion


TOMAR EN CUENTA RECOMENDACIONES DEL PROFESOR DESPUES DE PRESENTACION TEMA PROYECTO 

Retroalimentación en deberes
Comentario general
COMENTARIOS:

La parte de “Data Mining” no está definida. Indicar que se realiza EDA + anomalías opcionales no justifican el término si no se profundiza. En general, el proyecto trata sobre ingeniería de datos más BI. Para justificar el uso de Data Mining, es necesario responder al menos una pregunta analítica no trivial, por ejemplo: ¿Existen patrones de producción que expliquen desviaciones plan vs real? ¿Qué combinaciones de producto–cliente–periodo están asociadas a ineficiencias? ¿Se pueden detectar comportamientos atípicos antes de que impacten indicadores financieros?
Con respecto a la presentación, es necesario practicar y definir una estrategia eficiente de comunicación de las ideas. Además, es necesario comprender los conceptos relacionados al tema del proyecto para estar en la capacidad de responder a las preguntas. 
Es necesario ajustar la presentación al tiempo disponible.
Considerando que el documento de planificación está firmado por el tutor, se puede iniciar el desarrollo del proyecto integrador.
Se recomienda al estudiante seguir el cronograma definido y presentar de forma oportuna los entregables al tutor para su revisión.
De creerlo necesario, el estudiante puede solicitar ayuda complementaria al profesor del curso "Proyecto Integrador" para solventar inconvenientes en el desarrollo del proyecto.
Considerar las sugerencias y preguntas realizadas en la presentación de la planificación para un mejor desarrollo del proyecto integrador.
Ánimo en el desarrollo del proyecto!!

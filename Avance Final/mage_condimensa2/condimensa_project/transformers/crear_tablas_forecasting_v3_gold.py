...
def crear_tablas_forecasting_v3_gold(*args, **kwargs):
    """
    Mantiene Gold liviano para dashboard y analitica operacional.
    ...
    que consume el dashboard y las tablas de estado de productos.
    """
    ...
    CREATE TABLE IF NOT EXISTS gold.forecasting_productos_estacionales_v1 (
        id SERIAL PRIMARY KEY,
    ...
    CREATE TABLE IF NOT EXISTS gold.forecasting_productos_inactivos_v1 (
        id SERIAL PRIMARY KEY,
        producto_dashboard VARCHAR(255),
        tipo_producto VARCHAR(20),
    ...
    TRUNCATE TABLE gold.forecasting_productos_estacionales_v1;
    TRUNCATE TABLE gold.forecasting_productos_inactivos_v1;
    '''
    ...
    return {
        'status': 'SUCCESS',
        'tablas_gold': [
            'gold.pronostico_produccion_unificado_v1',

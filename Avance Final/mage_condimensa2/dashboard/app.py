...
from views import resumen, quickbooks_comercial, combinaciones, alertas, predicciones
...
elif pagina == "Indicadores Comerciales QuickBooks":
    quickbooks_comercial.render()
